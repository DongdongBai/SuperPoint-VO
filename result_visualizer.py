...
def main():
    # dataloader
    img_ids, sp_features, norm_features, sp_points, norm_points, gt_points = read_log("results/kitti_10.txt")
    # error
    ...
    if True:
        ...
        plt.plot(gt_points[:,0], gt_points[:,2],color="black",label="Ground Truth")        
        plt.plot(norm_points[:,0], norm_points[:,2],color="blue",label="Normal-VO")
